...
class MRHEndMissionButton: RscButtonMRHACC
{
	...
	action = """MRHACCMenu\endmission.sqf"" RemoteExec [""execVM"", 0, true];";//"[] execVM ""MRHACCMenu\endmission.sqf"";";
	x = 0.276875 * safezoneW + safezoneX;
...
class MRHReset: RscButtonMRHACC
{
	...
	action = """MRHACCMenu\allow.sqf"" RemoteExec [""execVM"", 0, true];";
	x = 0.276875 * safezoneW + safezoneX;
